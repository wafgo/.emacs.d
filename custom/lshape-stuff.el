(defun lshape-flash-monolith-tianma-sweet200-debug()
  "Flash the lshape traget with the scp flasher"
  (interactive)
  (async-shell-command "export SCP_FLASH_VARIANT=tianma_sweet200 && export SCP_FLASH_BUILD=DEBUG && cd /srv/scp-lshape-gc-flasher && ./flasher.py --flash_gc")
  )

(defun lshape-flash-monolith-tianma-sweet400-debug()
  "Flash the lshape traget with the scp flasher"
  (interactive)
