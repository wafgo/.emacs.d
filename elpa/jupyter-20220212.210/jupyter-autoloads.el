...
(register-definition-prefixes "jupyter-channel-ioloop-comm" '("jupyter-channel-ioloop-comm"))
...
(register-definition-prefixes "jupyter-client" '("com" "define-" "execute-request" "history-request" "is-complete-request" "jupyter-" "shutdown-request"))
...
(register-definition-prefixes "jupyter-comm-layer" '("jupyter-"))
...
(register-definition-prefixes "jupyter-ioloop-comm" '("jupyter-ioloop-comm"))
...
(register-definition-prefixes "jupyter-kernel-manager" '("jupyter-"))
...
(register-definition-prefixes "jupyter-kernel-process-manager" '("jupyter-"))
...
(register-definition-prefixes "jupyter-server-ioloop" '("jupyter-server-"))
